...
const messages = {
  en: {
    ...
    uploadOrthanc: 'Upload to Orthanc',
    orthancExportSuccess: 'Metrics JSON and CSV were uploaded to Orthanc.',
    orthancExportFailed: 'Could not upload metrics to Orthanc.',
  ...
  ru: {
    ...
    uploadOrthanc: 'Выгрузить в Orthanc',
    orthancExportSuccess: 'Файлы метрик JSON и CSV выгружены в Orthanc.',
    orthancExportFailed: 'Не удалось выгрузить метрики в Orthanc.',
