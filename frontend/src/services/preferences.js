...
const messages = {
  en: {
    ...
    sliceWithoutMask: 'Slice without mask',
    sliceWithMask: 'Slice with mask',
    plainSliceAlt: '{modality} MRI slice without segmentation mask',
    maskLegend: 'Mask legend',
    maskBackground: 'Background',
    maskNecrotic: 'Necrotic core',
    maskEdema: 'Edema',
    maskEnhancing: 'Enhancing tumor',
  ...
  ru: {
    ...
    sliceWithoutMask: 'Срез без маски',
    sliceWithMask: 'Срез с маской',
    plainSliceAlt: 'МРТ-срез {modality} без маски сегментации',
    maskLegend: 'Легенда маски',
    maskBackground: 'Фон',
    maskNecrotic: 'Некротическое ядро',
    maskEdema: 'Отёк',
    maskEnhancing: 'Усиливающаяся опухоль',
